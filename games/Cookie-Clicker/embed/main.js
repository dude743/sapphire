...
Game.Launch=function()
{
	...
	Game.ErrorFrame=function()
	{
		...
		'<small>(hi nate here i edited the anti pairacy message xd and i deleted it you will only see this for 1 second most likely" target="_blank">secondary URL</a>.)</small></div>';
	}
	Game.timedout=false;
